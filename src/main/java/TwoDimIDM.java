...
public class TwoDimIDM extends IDM {
     ...
     */
    public TwoDimIDM(double v0, double a0, double b, double T, double s0, double s1, double T1, double T2, double p, double timeStep) {
        super(v0, a0, b, T, s0, s1);
        this.p = p;
        this.T1 = T1;
        this.T2 = T2;
